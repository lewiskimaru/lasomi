...
export function TreeView({
      ...
      <div key={node.id} className="select-none">
        <motion.div
          className={cn(
            ...
            selectable && "hover:border-gray-200 dark:hover:border-gray-700",
          )}
        ...
        >
          ...
          {showLines && level > 0 && (
            <div className="absolute left-0 top-0 bottom-0 pointer-events-none">
              ...
              <div
                className="absolute top-1/2 border-t border-gray-300 dark:border-gray-600"
                style={{
              ...
              {isLast && (
                <div
                  className="absolute top-0 border-l border-gray-300 dark:border-gray-600"
                  style={{
                    left: (level - 1) * indent + 12,
                    height: "50%",
                  }}
          ...
          {showIcons && (
            <motion.div
              className="flex items-center justify-center w-4 h-4 mr-2 text-gray-500 dark:text-gray-400"
  ...
  return (
    <motion.div
      className={cn(
        "w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg",
        className,
      )}
